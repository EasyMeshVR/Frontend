		...
		<footer className={footerStyles.SiteFooter}>
            <div className={footerStyles.Container}>
                <div className={`${footerStyles.SiteFooterInner} ${footerStyles.hasTopDivider}`}>
                    ...
                    <ul className={`${footerStyles.FooterSocialLinks} ${footerStyles.ListReset}`}>
                        <li>
                            <a href="/">
                                <span className={footerStyles.ScreenReaderText}>Facebook</span>
                        ...
                        <li>
                            <a href="/">
                                <span className={footerStyles.ScreenReaderText}>Twitter</span>
                                <svg width="16" height="16" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <li>
                            <a href="/">
                                <span className={footerStyles.ScreenReaderText}>Google</span>
                                <svg width="16" height="16" xmlns="http://www.w3.org/2000/svg">
