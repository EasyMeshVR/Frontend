...
import deviceMockupImage from '../../resources/images/iphone-mockup.png';
		...
		<section className={mainSectionStyles.Hero}>
			<div className={mainSectionStyles.Container}>
				<div className={mainSectionStyles.HeroInner}>
					...
					{/* TODO: mockups/screenshots of the VR application  */}
					<img className={mainSectionStyles.DeviceMockup} src={deviceMockupImage} alt="App preview" />
				</div>
			</div>
		</section>
	)
